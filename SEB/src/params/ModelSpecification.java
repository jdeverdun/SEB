...
public class ModelSpecification {
	...
	public static SimpleVariable k1 = new SimpleVariable("k1",(float) 0.0025,null);//conductance ! ici correspond a resistance de 7 mmHg /(mL/min) // 8.5325e-4,null);//recalcule à partir de la publi 0.0011 ??k1 = 0.0025
	...
	public static SimpleVariable P_OUT_INITIAL = new SimpleVariable("P_OUT_INITIAL",(2.0f),null);
